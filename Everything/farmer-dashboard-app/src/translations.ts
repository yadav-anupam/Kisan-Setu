...
const hiTranslations: Translations = {
  ...
  home: {
    ...
    comparison: {
      traditionalTitle: 'पारंपरिक मंडी की चुनौतियाँ',
      kisanSetuTitle: 'किसान सेतु डिजिटल समाधान',
      traditionalPoints: [
        'किसानों को अत्यधिक भीड़ और घंटों लंबी कतारों में इंतजार करना पड़ता है।',
        'अनिश्चित खरीद कार्यक्रम के कारण मंडी जाने की योजना बनाना कठिन होता है।',
        'मैन्युअल टोकन और पर्ची प्रणाली में देरी व मानवीय त्रुटियों की संभावना रहती है।',
        'किसान अपनी कतार की स्थिति या अनुमानित प्रतीक्षा समय ट्रैक नहीं कर पाते।',
        'तौल और भुगतान की रीयल-टाइम जानकारी न मिलने से पारदर्शिता की कमी रहती है।',
      ],
      kisanSetuPoints: [
        'डिजिटल प्लेटफॉर्म के माध्यम से घर बैठे सुविधाजनक खरीद स्लॉट बुक करें।',
        'गेट पास सत्यापन पूरा करें और स्वचालित रूप से लाइव कतार में शामिल हों।',
        'टोकन, कतार स्थिति और AI-आधारित प्रतीक्षा समय को रीयल-टाइम में ट्रैक करें।',
        'तौल, गुणवत्ता जांच, खरीद और DBT भुगतान के लाइव अपडेट तुरंत प्राप्त करें।',
        'किसानों और मंडी स्टाफ दोनों के लिए सुरक्षित, पारदर्शी और केंद्र-स्तरीय प्रबंधन।',
      ],
    },
...
const mrTranslations: Translations = {
  ...
  home: {
    ...
    comparison: {
      traditionalTitle: 'पारंपरिक मंडीतील अडचणी',
      kisanSetuTitle: 'किसान सेतू डिजिटल उपाय',
      traditionalPoints: [
        'शेतकऱ्यांना जास्त गर्दी आणि अनेक तास लांब रांगेत उभे राहावे लागते.',
        'अस्पष्ट खरेदी वेळापत्रकामुळे बाजारात येण्याचे नियोजन करणे कठीण होते.',
        'मॅन्युअल टोकन व नोंदणीमुळे विनाविलंब काम होत नाही आणि चुका होतात.',
        'शेतकरी स्वतःची रांगेतील जागा किंवा अंदाजे वेळ ट्रॅक करू शकत नाहीत.',
        'खरेदी आणि पेमेंटच्या थेट माहितीच्या अभावामुळे पारदर्शकता कमी होते.',
      ],
      kisanSetuPoints: [
        'डिजिटल प्लॅटफॉर्मवरून आपल्या सोयीनुसार खरेदी स्लॉट आधीच बुक करा.',
        'गेट पास पडताळणी पूर्ण करा आणि थेट लाईव्ह रांगेत समाविष्ट व्हा.',
        'टोकन, रांगेतील क्रमांक आणि AI-आधारित वेळ रिअल-टाइममध्ये तपासा.',
        'वजन, गुणवत्ता तपासणी, खरेदी आणि DBT खात्यात जमा रकमेचे थेट अपडेट्स मिळवा.',
        'शेतकरी आणि केंद्र कर्मचाऱ्यांसाठी सुरक्षित, पारदर्शी आणि जलद व्यवस्थापन.',
      ],
    },
  },
  farmerLogin: {
...
const paTranslations: Translations = {
  ...
  home: {
    ...
    comparison: {
      traditionalTitle: 'ਰਵਾਇਤੀ ਮੰਡੀ ਦੀਆਂ ਮੁਸ਼ਕਿਲਾਂ',
      kisanSetuTitle: 'ਕਿਸਾਨ ਸੇਤੂ ਡਿਜੀਟਲ ਹੱਲ',
      traditionalPoints: [
        'ਕਿਸਾਨਾਂ ਨੂੰ ਲੰਬੀ ਉਡੀਕ ਅਤੇ ਭੀੜ-ਭੜੱਕੇ ਵਾਲੇ ਖਰੀਦ ਕੇਂਦਰਾਂ ਦਾ ਸਾਹਮਣਾ ਕਰਨਾ ਪੈਂਦਾ ਹੈ।',
        'ਅਸਪਸ਼ਟ ਖਰੀਦ ਸਮਾਂ-ਸਾਰਣੀ ਕਾਰਨ ਮੰਡੀ ਜਾਣ ਦੀ ਯੋਜਨਾ ਬਣਾਉਣਾ ਔਖਾ ਹੋ ਜਾਂਦਾ ਹੈ।',
        'ਮੈਨੁਅਲ ਟੋਕਨ ਅਤੇ ਗੇਟ-ਐਂਟਰੀ ਸਿਸਟਮ ਕਾਰਨ ਦੇਰੀ ਅਤੇ ਗਲਤੀਆਂ ਹੁੰਦੀਆਂ ਹਨ।',
        'ਕਿਸਾਨ ਆਪਣੀ ਲਾਈਵ ਲਾਈਨ ਸਥਿਤੀ ਜਾਂ ਅੰਦਾਜ਼ਨ ਉਡੀਕ ਸਮਾਂ ਨਹੀਂ ਦੇਖ ਸਕਦੇ।',
        'ਤੋਲ ਅਤੇ ਭੁਗਤਾਨ ਦੇ ਲਾਈਵ ਅਪਡੇਟ ਨਾ ਮਿਲਣ ਕਾਰਨ ਪਾਰਦਰਸ਼ਤਾ ਦੀ ਘਾਟ ਰਹਿੰਦੀ ਹੈ।',
      ],
      kisanSetuPoints: [
        'ਡਿਜੀਟਲ ਪਲੇਟਫਾਰਮ ਰਾਹੀਂ ਪਹਿਲਾਂ ਹੀ ਸੁਵਿਧਾਜਨਕ ਖਰੀਦ ਸਲਾਟ ਬੁੱਕ ਕਰੋ।',
        'ਗੇਟ ਪਾਸ ਤਸਦੀਕ ਪੂਰੀ ਕਰੋ ਅਤੇ ਆਪਣੇ ਆਪ ਲਾਈਵ ਲਾਈਨ ਵਿੱਚ ਸ਼ਾਮਲ ਹੋਵੋ।',
        'ਟੋਕਨ, ਲਾਈਨ ਸਥਿਤੀ ਅਤੇ AI-ਅਧਾਰਿਤ ਉਡੀਕ ਸਮਾਂ ਰੀਅਲ-ਟਾਈਮ ਵਿੱਚ ਟਰੈਕ ਕਰੋ।',
        'ਤੋਲ, ਗੁਣਵੱਤਾ ਜਾਂਚ, ਖਰੀਦ ਅਤੇ ਡੀਬੀਟੀ ਭੁਗਤਾਨਾਂ ਦੇ ਲਾਈਵ ਅਪਡੇਟ ਪ੍ਰਾਪਤ ਕਰੋ।',
        'ਕਿਸਾਨਾਂ ਅਤੇ ਸਟਾਫ ਲਈ ਸੁਰੱਖਿਅਤ, ਪਾਰਦਰਸ਼ੀ ਅਤੇ ਕੇਂਦਰ-ਅਨੁਸਾਰ ਪਹੁੰਚ ਯਕੀਨੀ ਬਣਾਓ।',
      ],
    },
  },
  farmerLogin: {
...
const bhoTranslations: Translations = {
  ...
  home: {
    ...
    comparison: {
      traditionalTitle: 'पुरान मंडी के परेशानी',
      kisanSetuTitle: 'किसान सेतु के डिजिटल समाधान',
      traditionalPoints: [
        'किसान भाई लोग के भारी भीड़ आ घंटन के लमहर लाइन में परेशान होखे के पड़ेला।',
        'खरीद के समय तय ना होखला से मंडी जाए के योजना बनावल कठिन होला।',
        'हाथ से टोकन आ पर्ची काटे में देरी आ गलती के संभावना रहेला।',
        'किसान आपन लाइन के नंबर चाहे इंतजार के समय ना जान पावेला।',
        'तौल आ पईसा के तुरंत जानकारी ना मिलला से पारदर्शिता के कमी रहेला।',
      ],
      kisanSetuPoints: [
        'घर बईठले मोबाइल से सुविधा अनुसार खरीद के स्लॉट बुक करीं।',
        'गेट पास जाँच करवा के तुरंत अपने-आप लाइव लाइन में जुड़ जाईं।',
        'टोकन नंबर, लाइन में अपना जगह आ समय के लाइव मोबाइल पर देखीं।',
        'तौल, जाँच, खरीद आ बैंक खाता में पईसा के तुरंत अपडेट पाईं।',
        'किसान आ मंडी स्टाफ खातिर सुरक्षित, साफ-सुथरा आ आधुनिक व्यवस्था।',
      ],
    },
  },
  farmerLogin: {
...
const teTranslations: Translations = {
  ...
  home: {
    ...
    comparison: {
      traditionalTitle: 'సాంప్రదాయ మార్కెట్ సవాళ్లు',
      kisanSetuTitle: 'కిసాన్ సేతు డిజిటల్ పరిష్కారం',
      traditionalPoints: [
        'రైతులు ఎక్కువ సమయం వేచి ఉండటం మరియు కిక్కిరిసిన సేకరణ కేంద్రాల సమస్యను ఎదుర్కొంటారు.',
        'అస్పష్టమైన సేకరణ షెడ్యూల్ కారణంగా రాకను ప్లాన్ చేసుకోవడం కష్టమవుతుంది.',
        'మాన్యువల్ టోకెన్ మరియు గేట్-ఎంట్రీ విధానం వల్ల ఆలస్యం మరియు లోపాలు జరుగుతాయి.',
        'రైతులు తమ లైవ్ క్యూ స్థానాన్ని లేదా వేచి ఉండే సమయాన్ని తెలుసుకోలేరు.',
        'రియల్-టైమ్ సేకరణ మరియు చెల్లింపు వివరాలు లేకపోవడం పారదర్శకతను తగ్గిస్తుంది.',
      ],
      kisanSetuPoints: [
        'డిజిటల్ ప్లాట్‌ఫామ్ ద్వారా ముందుగానే అనుకూలమైన సేకరణ స్లాట్‌ను బుక్ చేసుకోండి.',
        'గేట్-పాస్ ధృవీకరణ పూర్తి చేసి ఆటోమేటిక్‌గా లైవ్ క్యూలో చేరండి.',
        'టోకెన్, క్యూ స్థానం మరియు AI-అంచనా వేసిన వేచి ఉండే సమయాన్ని రియల్-టైమ్‌లో ట్రాక్ చేయండి.',
        'తూకం, నాణ్యత తనిਖీ, సేకరణ మరియు DBT చెల్లింపుల లైవ్ అప్‌డేట్‌లను పొందండి.',
        'రైతులు మరియు సిబ్బందికి సురక్షితమైన, పారదర్శకమైన మరియు వేగవంతమైన సేవలు.',
      ],
    },
  },
  farmerLogin: {
...
const knTranslations: Translations = {
  ...
  home: {
    ...
    comparison: {
      traditionalTitle: 'ಸಾಂಪ್ರದಾಯಿಕ ಮಂಡಿ ಸವಾಲುಗಳು',
      kisanSetuTitle: 'ಕಿಸಾನ್ ಸೇತು ಡಿಜಿಟಲ್ ಪರಿಹಾರ',
      traditionalPoints: [
        'ರೈತರು ದೀರ್ಘ ಕಾಯುವಿಕೆ ಮತ್ತು ಜನದಟ್ಟಣೆಯ ಖರೀದಿ ಕೇಂದ್ರಗಳ ಸಮಸ್ಯೆಯನ್ನು ಎದುರಿಸುತ್ತಾರೆ.',
        'ಅಸ್ಪಷ್ಟ ಖರೀದಿ ವೇಳಾಪಟ್ಟಿಯಿಂದಾಗಿ ಭೇಟಿಯನ್ನು ಯೋಜಿಸುವುದು ಕಷ್ಟವಾಗುತ್ತದೆ.',
        'ಮ್ಯಾನುಯಲ್ ಟೋಕನ್ ಮತ್ತು ಗೇಟ್-ಪ್ರವೇಶ ವ್ಯವಸ್ಥೆಯು ವಿಳಂಬ ಮತ್ತು ತಪ್ಪುಗಳಿಗೆ ಕಾರಣವಾಗುತ್ತದೆ.',
        'ರೈತರು ತಮ್ಮ ಲೈವ್ ಕ್ಯೂ ಸ್ಥಾನ ಅಥವಾ ಕಾಯುವ ಸಮಯವನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡಲು ಸಾಧ್ಯವಿಲ್ಲ.',
        'ನೈಜ-ಸಮಯದ ಖರೀದಿ ಮತ್ತು ಪಾವತಿ ನವೀಕರಣಗಳ ಕೊರತೆಯು ಪಾರದರ್ಶಕತೆಯನ್ನು ಕಡಿಮೆ ಮಾಡುತ್ತದೆ.',
      ],
      kisanSetuPoints: [
        'ಡಿಜಿಟಲ್ ಪ್ಲಾಟ್‌ಫಾರ್ಮ್ ಮೂಲಕ ಅನುಕೂಲಕರ ಖರೀದಿ ಸ್ಲಾಟ್ ಅನ್ನು ಮೊದಲೇ ಬುಕ್ ಮಾಡಿ.',
        'ಗೇಟ್ ಪಾಸ್ ಪರಿಶೀಲನೆ ಪೂರ್ಣಗೊಳಿಸಿ ಮತ್ತು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಲೈವ್ ಕ್ಯೂಗೆ ಸೇರಿಕೊಳ್ಳಿ.',
        'ಟೋಕನ್, ಕ್ಯೂ ಸ್ಥಾನ ಮತ್ತು AI-ಅಂದಾಜು ಕಾಯುವ ಸಮಯವನ್ನು ನೈಜ ಸಮಯದಲ್ಲಿ ಟ್ರ್ಯಾಕ್ ಮಾಡಿ.',
        'ತೂಕ, ಗುಣಮಟ್ಟ ಪರಿಶೀಲನೆ, ಖರೀದಿ ಮತ್ತು DBT ಪಾವತಿಗಳ ಲೈವ್ ಅಪ್‌ಡೇಟ್‌ಗಳನ್ನು ಪಡೆಯಿರಿ.',
        'ರೈತರು ಮತ್ತು ಸಿಬ್ಬಂದಿಗೆ ಸುರಕ್ಷಿತ, ಪಾರದರ್ಶಕ ಮತ್ತು ಕೇಂದ್ರವಾರು ಸೇವೆಗಳು.',
      ],
    },
  },
  farmerLogin: {
...
const mlTranslations: Translations = {
  ...
  home: {
    ...
    comparison: {
      traditionalTitle: 'പരമ്പരാഗത മണ്ഡി വെല്ലുവിളികൾ',
      kisanSetuTitle: 'കിസാൻ സേതു ഡിജിറ്റൽ പരിഹാരം',
      traditionalPoints: [
        'കർഷകർ നീണ്ട കാത്തിരിപ്പും തിങ്ങിനിറഞ്ഞ സംഭരണ കേന്ദ്രങ്ങളും അഭിമുഖീകരിക്കുന്നു.',
        'വ്യക്തമല്ലാത്ത സംഭരണ സമയക്രമം കാരണം വരവ് പ്ലാൻ ചെയ്യുന്നത് ബുദ്ധിമുട്ടാകുന്നു.',
        'മാനുവൽ ടോക്കണും ഗേറ്റ് എൻട്രി സംവിധാനവും കാലതാമസത്തിനും പിശകുകൾക്കും കാരണമാകുന്നു.',
        'കർഷകർക്ക് അവരുടെ ലൈവ് ക്യൂ സ്ഥാനമോ പ്രതീക്ഷിക്കുന്ന കാത്തിരിപ്പ് സമയമോ ട്രാക്ക് ചെയ്യാനാവില്ല.',
        'തത്സമയ സംഭരണ-പേയ്‌മെന്റ് വിവരങ്ങളുടെ അഭാവം സുതാര്യത കുറയ്ക്കുന്നു.',
      ],
      kisanSetuPoints: [
        'ഡിജിറ്റൽ പ്ലാറ്റ്‌ഫോമിലൂടെ മുൻകൂട്ടി സൗകര്യപ്രദമായ സംഭരണ സ്ലോട്ട് ബുക്ക് ചെയ്യുക.',
        'ഗേറ്റ് പാസ് പരിശോധന പൂർത്തിയാക്കി സ്വയമേവ ലൈവ് ക്യൂവിൽ ചേരുക.',
        'ടോക്കൺ, ക്യൂ സ്ഥാനം, AI-പ്രവചിത കാത്തിരിപ്പ് സമയം എന്നിവ തത്സമയം ട്രാക്ക് ചെയ്യുക.',
        'തൂക്കം, ഗുണനിലവാര പരിശോധന, സംഭരണം, DBT പേയ്‌മെന്റുകൾ എന്നിവയുടെ ലൈവ് വിവരങ്ങൾ നേടുക.',
        'കർഷകർക്കും ഉദ്യോഗസ്ഥർക്കും സുരക്ഷിതവും സുതാര്യവുമായ സേവനം ഉറപ്പാക്കുക.',
      ],
    },
  },
  farmerLogin: {
